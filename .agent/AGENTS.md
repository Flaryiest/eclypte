...
- **Cloud REST API V1 Routes**:
  ...
  - Publishing: `GET /v1/publishing/config`, `GET|POST /v1/publishing/posts`, `PATCH /v1/publishing/posts/{post_id}`, and `{post_id}/regenerate-caption|send-buffer|refresh-status|cancel` — review-gated Buffer Instagram Reels publishing.
