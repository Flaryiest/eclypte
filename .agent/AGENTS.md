...
- **Current Repo Map**:
  ...
  - `api/prototyping/music/`: the pure analysis helper, lyric lookup, and the Modal-backed music analysis app (`eclypte-analysis`). YouTube audio download and R2 publishing now live in the control plane (`api/youtube_download.py`, `api/workflows.py`).
...
- **Cloud REST API V1 Routes**:
  ...
  - Workflows: `POST /v1/music/analyses`, `POST /v1/music/youtube-imports`, `POST /v1/music/conversions`, `POST /v1/video/analyses`, `POST /v1/timelines`, `POST /v1/renders`, `POST /v1/edits`
